<div align="center">
  ...
  <a href="https://PrathamDhobe.github.io/gamics/"><strong>➥ Live Demo</strong></a>
...
```bash
sudo git clone https://github.com/PrathamDhobe/gamics.git
```

Windows:

```bash
git clone https://github.com/PrathamDhobe/gamics.git
```
